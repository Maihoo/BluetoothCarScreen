...
public class BluetoothChatService {
     ...
     */
    public BluetoothChatService(Context context, Handler handler, BluetoothChat btc) {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        mConnectedThread = new ConnectedThread(socket, btc);
                    ...
                    synchronized (BluetoothChatService.this) {
                        switch (mState) {
                            ...
                            case STATE_CONNECTING:
                                ...
                                {
                                    Log.e("HERE IS THE PROBLEM", "REEE");
                                }
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket, BluetoothChat btc) {
        ...
        public void writeWord(byte[] buffer) {
            try {
                byte[] p = "pic".getBytes(StandardCharsets.UTF_8);
                byte[] together = new byte[buffer.length + 3];

                System.arraycopy(p, 0, together, 0, 3);
                System.arraycopy(buffer, 0, together, 3, buffer.length);

                mmOutStream.write(together, 0, together.length);
                mmOutStream.flush();
            } catch (IOException e) {
                Log.e(TAG, "Exception during write", e);
            }
